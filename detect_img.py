...
parser = argparse.ArgumentParser(description='detect_img')
...
parser.add_argument('--path', default="./imgs/1.jpg", type=str,
                    help='img path')
...
cv2.imwrite(os.path.join(result_path, os.path.basename(img_path)), orig_image)
